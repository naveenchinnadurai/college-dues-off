      ...
      <View>
        {
          notifications.map((item,i)=>{
            return (
              <View key={i} className={`flex-row items-center justify-between ${item.bgColor} p-4 rounded-lg mb-3`}>
                <View className="flex-row items-center">
                  ...
                  <View>
                    <Text className="text-black font-medium">{item.name} {item.bgColor}</Text>
