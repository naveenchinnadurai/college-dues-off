    ...
    return (
        <View className='flex-1 bg-white overflow-hidden items-center'>
            ...
            <View className='flex flex-col gap-5'>
                <Link href="/studentLogin" className='py-5 px-14 bg-gray-100 rounded-3xl gap-2 h-40'>
                    <Icon name="user-graduate" size={70} color="#000" />
                    <Text className='text-xl font-medium'>Student</Text>
                </Link>
                <Link href="/staffLogin" className='py-5 px-14 bg-gray-100 flex flex-col justify-center items-center rounded-3xl gap-2 h-40'>
